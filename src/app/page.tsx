...
const SECTORS = [
  { icon: Activity, name: 'Santé', color: 'text-red-500' },
  { icon: PieChart, name: 'Éducation', color: 'text-blue-500' },
  { icon: Database, name: 'Agriculture', color: 'text-green-500' },
  { icon: TrendingUp, name: 'Finance', color: 'text-yellow-500' },
  { icon: Building2, name: 'Infrastructure', color: 'text-gray-500' },
  { icon: Users, name: 'Social', color: 'text-purple-500' },
];
